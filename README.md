...
Kotlin Multiplatform line-by-line clean-room port of the Rust crate [`similar`](https://crates.io/crates/similar).

> **Status: scaffold — porting has not started.** This repo currently contains build infrastructure only. The upstream Rust source for the `similar` crate will be cloned into `tmp/` (gitignored) when porting begins.

## About

Diff / similarity algorithms
...
Original work copyrighted by the upstream `similar` authors. Kotlin port copyright (c) 2026 Sydney Renee and The Solace Project.
