...
This file is the quick-reference operating contract for similar-kotlin. The longer
...
similar-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`similar`](https://crates.io/crates/similar). Upstream Rust is the behavioral oracle while the
